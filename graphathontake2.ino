...
static float DEHRADUN_LAT = 30.3165, DEHRADUN_LON = 78.0322;
void setup()
{
  ...
  cell.Boot(); 
  cell.FwdSMS2Serial();
  cell.Rcpt("+918755748597");
  cell.Message("NEED HELP!!! \n 30.3165 N, 78.0322 E");
  cell.SendSMS();
  Serial.println();
  Serial.println(" Latitude  Longitude  Chars Sentences Checksum");
